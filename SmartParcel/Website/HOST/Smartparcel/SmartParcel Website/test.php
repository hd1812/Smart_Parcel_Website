...
$web->user_address = $_POST['user_address'];
$web->user_county = $_POST['user_county'];
...
{
    $addrtn = $web->add_user();
    $web->user_id = $addrtn['user_id'];
    print($web->user_id);
    //TODO: USER_ID NOT VALID
    if($rtnarr['rtnstatus'] == "success")
    {
        $webrtn = $web->add_address();
        print_r($webrtn);
    }
    else
    {
        echo "add_user operation failed, address addition aborted. <br>";
    }
